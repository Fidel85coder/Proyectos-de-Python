...
aplicacion.geometry('1120x630+0+0')  # dimensiones y donde aparece

# evitar maximizar
aplicacion.resizable(False, False)

# titulo ventana
aplicacion.title("Mi Restaurante - Sistema")

# color de fondo ventana
aplicacion.config(bg='burlywood')

# panel superior
panel_superior = Frame(aplicacion, bd=1, relief=FLAT)  # bd es borde del panel y relief relieve
panel_superior.pack(side=TOP)

# etiqueta titulo
etiqueta_titulo = Label(panel_superior, text='Sistema de Facturación', fg='azure4',  # fg es color del texto
...
panel_bebidas = LabelFrame(panel_izquierdo, text='Bebidas', font=('Dosis', 19, 'bold'),
                           bd=1, relief=FLAT, fg='azure4')
panel_bebidas.pack(side=LEFT)  # se va ir a la izquierda del de comidas
...
panel_calculadora.pack()  # por defecto irá arriba
...
for comida in lista_comidas:
    ...
    comida = Checkbutton(panel_comidas,
                         text=comida.title(),
                         font=('Dosis', 19, 'bold'),
                         onvalue=1,  # casilla activa 1, desactivada 0
                         offvalue=0,
                         variable=variables_comida[contador],
                         command=revisar_check)
    comida.grid(row=contador,
                column=0,
                sticky=W)  # sticky es para alinear

    # crear cuadros de entrada
    cuadros_comida.append('')
    texto_comida.append('')  # es para que existan
    ...
    cuadros_comida[contador] = Entry(panel_comidas,
                                     ...
                                     bd=1,
                                     width=6,
                                     state=DISABLED,  # no activo hasta activar check
...
# botones
botones = ['total', 'recibo', 'guardar', 'reseteo']
botones_creados = []
columnas = 0
...
for boton in botones_calculadora:
    ...
    boton.grid(row=fila,
               column=columna, sticky="nsew", padx=0, pady=0)
